...
const QUESTIONS = [
  ...
  { id: 5, text: "Gabi has a weirdly specific skill: she's really good at __________.", truth: "mechanics" },
  { id: 6, text: "When Paul isn't working at R2, he spends most of his time __________.", truth: "working on his business" },
  { id: 7, text: "In college, Pedro made some extra money by __________.", truth: "moving furniture" },
  { id: 8, text: "In college, Pedro was part of __________.", truth: "a fraternity" },
  { id: 9, text: "Pedro nicknamed MJ after Spider-Man's MJ — but before that, her nickname was __________.", truth: "Jimenoide" },
  { id: 10, text: "At the last offsite, Dimi shared a room with __________.", truth: "Pedro" },
  { id: 11, text: "Daniel has a neighbor who blasts music at all hours — the song they play on repeat is __________.", truth: "la copa rota" },
  { id: 12, text: "Daniel already knew one person at R2 before joining — that person is __________.", truth: "Cata" },
  { id: 13, text: "Paul lives in __________.", truth: "Argentina" },
  { id: 14, text: "Daniel shares his first name with a famous __________ singer.", truth: "bolero" },
  { id: 15, text: "Paul is such a sneakerhead that he actually designs sneakers for an Argentine brand called __________.", truth: "[FILL IN TRUTH]" },
  { id: 16, text: "When Gabi was a kid, her pet was a __________.", truth: "sheep" },
  { id: 17, text: "Gabi has a second degree in __________.", truth: "environmental engineering" },
  { id: 18, text: "Something few people know about Dimi: he holds permanent residency in __________ different countries.", truth: "3" },
];
